...
REF_ISO_PROFILE_REPO_GIT_URL="https://github.com/samwhelp/anduinos-iso-builder-develop.git"

REF_ISO_PROFILE_REPO_BRANCH_NAME="main"

#REF_ISO_PROFILE_REPO_ARCHIVE_URL="https://github.com/samwhelp/anduinos-iso-builder-develop/archive/refs/heads/${REF_ISO_PROFILE_REPO_BRANCH_NAME}.zip"
REF_ISO_PROFILE_REPO_ARCHIVE_URL="https://github.com/samwhelp/anduinos-iso-builder-develop/archive/refs/heads/${REF_ISO_PROFILE_REPO_BRANCH_NAME}.tar.gz"


REF_ISO_PROFILE_REPO_ARCHIVE_FILE_NAME="${REF_ISO_PROFILE_REPO_BRANCH_NAME}.tar.gz"
REF_ISO_PROFILE_REPO_ARCHIVE_EXTRACT_DIR_NAME="anduinos-iso-builder-develop-${REF_ISO_PROFILE_REPO_BRANCH_NAME}"
...
REF_WORK_DIR_PATH="${HOME}/work/anduinos-iso-builder-remix-mate-with-compiz"
